...
const ACTIVITIES = [
  ...
  { n: '04', title: 'Дружеские игры', desc: 'Забронируйте симулятор на компанию — до 4 человек.' },
        ...
        {ACTIVITIES.map((a, i) => (
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-xl md:text-2xl text-[var(--text-primary)] uppercase tracking-wide font-medium mb-2 group-hover:text-brand-orange transition-colors">
                {a.title}
              </h3>
              <p className="text-[var(--text-subtle)] leading-relaxed">{a.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
