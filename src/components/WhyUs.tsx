  ...
  return (
    <Section eyebrow="Почему Indoor Golf" title="Первое в России">
        ...
        {ITEMS.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="display text-3xl text-white uppercase mb-4 tracking-wide">
                {item.title}
              </h3>
      ...
      <motion.p
        ...
        className="mt-16 text-center text-xl md:text-2xl text-white/70 font-light leading-relaxed max-w-3xl mx-auto"
      >
