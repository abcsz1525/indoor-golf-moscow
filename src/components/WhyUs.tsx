...
const ITEMS = [
  ...
  },
  {
    icon: MapPin,
    title: 'Лужники',
    text: 'Премиальное расположение в сердце Москвы — Дворец тенниса, охраняемая парковка на территории.',
  },
];

export function WhyUs() {
  return (
    <Section eyebrow="Почему Indoor Golf" title="Гольф круглый год">
