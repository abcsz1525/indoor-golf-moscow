...
const SEGMENTS = [
  ...
  },
  {
    icon: Users,
    title: 'Корпоратив',
    text: 'Турнир для команды от 4 до 20 человек: инструкторы, турнирная таблица, кафе в этом же здании.',
  ...
  },
  {
    icon: Baby,
    title: 'Ребёнку',
    text: 'Занятия с тренером для детей от 7 лет: техника, координация и азарт — без поездок за город.',
